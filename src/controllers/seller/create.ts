import { sellerSchema, BadRequestError } from "@users/config";
import { createSeller, getSellerByEmail } from "@users/services";
import { ISellerDocument } from "@users/interfaces";
